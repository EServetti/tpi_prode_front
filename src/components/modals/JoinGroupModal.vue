...
import JoinGroup, { type JoinGroupPayload } from '../forms/JoinGroup.vue'
...
const onSubmit = (payload: JoinGroupPayload) => {
  emit('submit', payload)
}
</script>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h3 id="join-group-title" class="!mb-0 text-lg">Unirme a un grupo</h3>
            <button
              type="button"
